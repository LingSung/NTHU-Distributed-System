...
/*
TODO: 1. Call dao API to list comment and check if any error happen. If so, return an nil response.
...
func (s *service) CreateComment(ctx context.Context, req *pb.CreateCommentRequest) (*pb.CreateCommentResponse, error) {
	if _, err := s.videoClient.GetVideo(ctx, &videopb.GetVideoRequest{Id: req.GetVideoId()}); err != nil {
		return nil, err
	}
...
/*
TODO: 1. Update a comment with information in request.
...
/*
TODO: 1. Call dao API to delete a comment and do error handling. You need to handle comment not found error and other unknown error here.
...
/*
TODO: 1. Call dao API to delete comments by video id and do error handling. You need to do error handling here.
	  2. Return the response.
*/
